...
function GrokMark() {
  return (
    <svg width="14" height="14" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
      <path d="M22.8 8.4c1.9 2.4 2.7 5.5 2.1 8.6l-2.8-.7c.4-2.3-.2-4.6-1.7-6.4l2.4-1.5z" />
      <path d="M9.2 23.6c-1.9-2.4-2.7-5.5-2.1-8.6l2.8.7c-.4 2.3.2 4.6 1.7 6.4l-2.4 1.5z" />
      <path d="M27.4 5.8 7.1 26.1 5.4 24.4 25.7 4.1l1.7 1.7z" />
      <path d="M6.6 26.2 26.9 5.9l1.7 1.7L8.3 27.9 6.6 26.2z" />
    </svg>
  );
}
