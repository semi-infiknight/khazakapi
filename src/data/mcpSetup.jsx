...
export const PLATFORMS = [
  {
    ...
    mcp: {
      ...
      step2Body: "In Claude desktop or claude.ai, go to Customize → Connectors. Name it Kazakh and paste the URL",
    ...
    cli: {
      ...
      step3Body: "Ask it to search the Kazakh catalogue or open a specific KZ API",
      startCta: "Open docs",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "In Grok, add a custom MCP connector. Name it Kazakh and paste the URL",
      step2Cta: "Open Grok",
    ...
    cli: {
      ...
      step3Body: "Ask Grok to search Kazakh for Kazhydromet or Kaspi APIs",
      startCta: "Open Grok",
      startHref: "https://grok.com",
    },
  },
  {
    ...
    mcp: {
      ...
      step2Body: "In ChatGPT settings, add an MCP connector. Name it Kazakh and paste the URL",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Register Kazakh as a remote HTTP MCP server in Claude Code settings",
      step2Cta: "Claude Code docs",
      step2Href: "https://docs.anthropic.com/en/docs/claude-code",
      step3Title: "Connect, sign in and start",
      step3Body: "Ask Claude Code to search the Kazakh catalogue while you build",
      startCta: "Start exploring",
      startHref: "https://docs.anthropic.com/en/docs/claude-code",
    },
    cli: {
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Add a remote MCP connector named Kazakh and paste the URL",
    ...
    cli: {
      ...
      step2Body: "Run the command from step 1 to point OpenClaw at Kazakh",
      step2Cta: "OpenClaw",
      step2Href: "https://openclaw.ai",
      step3Title: "Connect and start",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Create a new HTTP MCP connector named Kazakh and paste the URL",
    ...
    cli: {
      ...
      step2Body: "Run the command from step 1 to register Kazakh",
      step2Cta: "Hermes",
      step2Href: "https://hermes.ai",
      step3Title: "Connect and start",
