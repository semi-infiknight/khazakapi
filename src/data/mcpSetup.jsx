...
function GrokMark() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M3 3.5h10v2H8.8L13 12.5h-2.6L7.2 7H6.1v5.5H3.5V3.5H3Z" fill="currentColor" />
    </svg>
  );
}
...
export const PLATFORMS = [
  {
    ...
    mcp: {
      ...
      step2Body: "In Claude desktop or claude.ai, go to Customize → Connectors. Name it Khazak and paste the URL",
    ...
    cli: {
      command: (url) => `claude mcp add --transport http khazak-api ${url}`,
      ...
      step3Body: "Ask it to search the Khazak catalogue or open a specific KZ API",
      startCta: "Open docs",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "In Grok, add a custom MCP connector. Name it Khazak and paste the URL",
      step2Cta: "Open Grok",
    ...
    cli: {
      command: (url) => `grok mcp add khazak-api --url "${url}"`,
      ...
      step3Body: "Ask Grok to search Khazak for Kazhydromet or Kaspi APIs",
      startCta: "Open Grok",
      startHref: "https://grok.com",
    },
  },
  {
    ...
    mcp: {
      ...
      step2Body: "In ChatGPT settings, add an MCP connector. Name it Khazak and paste the URL",
    ...
    cli: {
      command: (url) => `codex mcp add khazak-api --url "${url}"`,
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Add a new MCP server (URL / HTTP). Name it khazak-api and paste the URL",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Register Khazak as a remote HTTP MCP server in Claude Code settings",
      step2Cta: "Claude Code docs",
      step2Href: "https://docs.anthropic.com/en/docs/claude-code",
      step3Title: "Connect, sign in and start",
      step3Body: "Ask Claude Code to search the Khazak catalogue while you build",
      startCta: "Start exploring",
      startHref: "https://docs.anthropic.com/en/docs/claude-code",
    },
    cli: {
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Add a remote MCP connector named Khazak and paste the URL",
    ...
    cli: {
      command: (url) => `openclaw mcp register khazak-api --url "${url}"`,
      step2Title: "Register with OpenClaw CLI",
      step2Body: "Run the command from step 1 to point OpenClaw at Khazak",
      step2Cta: "OpenClaw",
      step2Href: "https://openclaw.ai",
      step3Title: "Connect and start",
  ...
  },
  {
    ...
    mcp: {
      ...
      step2Body: "Create a new HTTP MCP connector named Khazak and paste the URL",
    ...
    cli: {
      command: (url) => `hermes mcp add khazak-api --endpoint "${url}"`,
      step2Title: "Add with Hermes CLI",
      step2Body: "Run the command from step 1 to register Khazak",
      step2Cta: "Hermes",
      step2Href: "https://hermes.ai",
      step3Title: "Connect and start",
