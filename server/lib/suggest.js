...
import { apiMatchesFeature, buildPlugInContext, capabilityOverlap, getApiCapabilities } from "./apiCapabilities.js";
  ...
  return {
    ...
    summary:
      reason === "no_apis_matched"
        ...
        : `We don’t have a good API fit for “${query}” in this catalogue. KhazakAPI focuses on Kazakhstan payments, maps, delivery, banking, travel, weather, telecom, and government open data.`,
