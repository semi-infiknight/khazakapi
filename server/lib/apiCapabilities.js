...
export const API_CAPABILITY_OVERRIDES = {
  ...
  "kz-npck-pis-init": ["checkout-payment", "bank-transfer", "open-banking"],
  "kz-npck-pis-status": ["checkout-payment", "bank-transfer"],
  "kz-npck-consent-create": ["user-auth", "oauth", "open-banking"],
  "kz-npck-consent-revoke": ["user-auth", "oauth", "open-banking"],
  "kz-npck-ais-transactions": ["bank-accounts", "open-banking"],
