    ...
    [
      {
        role: "system",
        content:
          "You are Qazaq Stack doc assistant. Answer ONLY using the API facts provided. If the facts do not contain the answer, say you do not have that detail in the catalogue and point to official docs. Max 3 short sentences. Plain English. Do not invent parameters or URLs.",
      },
      {
        role: "user",
        content: `API facts:\n${context}\n\nQuestion: ${q}`,
